...
import (
	...
	"github.com/getcouragenow/packages/sys-account/pkg/dao"
...
func TestMakeSchema(t *testing.T) {
	t.Log("MakeSchema testing .....")

	_, err := dao.NewAccountDB(testDb)
...
// 	}
//
// 	u := dao.Account{ID: db.UID(), Name: "user1", Email: "example001@gmail.com"}
...
// 		log.Printf("user => %v", out.(*dao.Account))
// 	}); err != nil {
// 		t.Error(err)
// 	}
//
